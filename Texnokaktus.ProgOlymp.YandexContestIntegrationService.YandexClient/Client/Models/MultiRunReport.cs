...
#nullable restore
        ...
        public global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_globalError? GlobalError { get; set; }
...
#nullable restore
        ...
        public global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_status? Status { get; set; }
...
#nullable restore
        ...
        public global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_testFileType? TestFileType { get; set; }
        /// <summary>The tests property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.TestLog>? Tests { get; set; }
#nullable restore
#else
        public List<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.TestLog> Tests { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "globalError", n => { GlobalError = n.GetEnumValue<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_globalError>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_status>(); } },
                { "submissionTime", n => { SubmissionTime = n.GetStringValue(); } },
                { "testFileType", n => { TestFileType = n.GetEnumValue<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_testFileType>(); } },
                { "tests", n => { Tests = n.GetCollectionOfObjectValues<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.TestLog>(global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.TestLog.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_globalError>("globalError", GlobalError);
            ...
            writer.WriteEnumValue<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_status>("status", Status);
            writer.WriteStringValue("submissionTime", SubmissionTime);
            writer.WriteEnumValue<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.MultiRunReport_testFileType>("testFileType", TestFileType);
            writer.WriteCollectionOfObjectValues<global::Texnokaktus.ProgOlymp.YandexContestIntegrationService.Client.Models.TestLog>("tests", Tests);
